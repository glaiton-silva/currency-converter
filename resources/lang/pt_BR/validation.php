...
return [
    ...
    | convenção "atributo.regra" para nomear as linhas. Isso torna rápido para
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar nosso marcador de espaço de atributo
    | com algo mais amigável ao leitor, como "Endereço de E-Mail"
    | em vez de "email". Isso simplesmente nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
